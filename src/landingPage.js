  ...
  return (
    <div>
        ...
        <div className="container-fluid">
            ...
            <a className='signin'><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-person" viewBox="0 0 16 16">
  ...
  return (
    <div>
        ...
        <div>
            ...
            <p className="mb-0">MORE TEXT <a href="/">Visit the homepage</a> OOOR <a href="/docs/5.0/getting-started/introduction/">and orr!</a>.</p>
        </div>
        </footer>
    </div>
  )
